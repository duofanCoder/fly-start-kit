...
public class AlipayTradeProperty {
    ...
    public static class FaceTradeProperties {
        ...
        private String encryptKey = "jbgWjMJiy874+ARX6JGKew==";
        private String serverUrl = "https://openapi.alipaydev.com/gateway.do";
        private String signType = "RSA2";
        private String charset = "UTF8";
        private String format = "json";
        private String notifyUrl = "https://alipay.duofan.top/face-trade/callback";
